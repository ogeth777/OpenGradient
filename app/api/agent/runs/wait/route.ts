...
export async function POST(req: Request) {
  try {
    ...
    console.log("Received /api/agent/runs/wait request:", JSON.stringify(body, null, 2));
    ...
    if (envKey) {
        ...
        if (headerKey !== envKey) {
             console.log("Blocked unauthorized request to /api/agent/runs/wait");
    ...
    try {
        ...
        console.error("Agent Error in /api/agent/runs/wait:", agentError);
